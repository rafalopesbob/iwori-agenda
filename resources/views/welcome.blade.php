    ...
    <div class="flex flex-wrap items-center justify-center gap-3 mt-8">
        @auth
            <a href="{{ route('sessions.index') }}"
               class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl font-medium text-lg">Ir para a agenda</a>
        ...
        @else
            <a href="{{ route('register') }}"
               class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl font-medium text-lg">Começar agora</a>
            <a href="{{ route('login') }}"
...
<section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pb-12">
    <div class="bg-white rounded-2xl shadow p-6">
        ...
        <h2 class="font-semibold text-gray-900 mt-3">Calendário dinâmico</h2>
    ...
    <div class="bg-white rounded-2xl shadow p-6">
        <p class="text-3xl">👥</p>
        <h2 class="font-semibold text-gray-900 mt-3">Gestão de clientes</h2>
        <p class="text-sm text-gray-600 mt-2">
    ...
    <div class="bg-white rounded-2xl shadow p-6">
        <p class="text-3xl">💰</p>
        <h2 class="font-semibold text-gray-900 mt-3">Faturamento inteligente</h2>
        <p class="text-sm text-gray-600 mt-2">
    ...
    <div class="bg-white rounded-2xl shadow p-6">
        <p class="text-3xl">🔒</p>
        <h2 class="font-semibold text-gray-900 mt-3">Dados protegidos</h2>
        <p class="text-sm text-gray-600 mt-2">
