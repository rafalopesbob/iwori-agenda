...
<div class="max-w-md mx-auto bg-white rounded-2xl shadow p-8">
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-4">
        ...
        <label class="flex items-center gap-2 text-sm">
            <input type="checkbox" name="remember" class="rounded border-gray-300 text-mvteal">
            Manter conectado
        </label>
    ...
    <p class="text-sm text-gray-600 mt-6 text-center">
        Ainda não tem conta?
        <a href="{{ route('register') }}" class="text-mvteal-dark font-medium hover:underline">Criar conta</a>
    </p>
</div>
@endsection
